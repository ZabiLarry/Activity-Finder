...
public class OutdoorController extends AbstractController implements Initializable {
    ...
    @FXML
    private Button kajak,
            outClimbing, outSwimming, hiking, fishing, adventure, golf, paintball;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        BackgroundImage backgroundImage = new BackgroundImage(new Image(getClass().getResource("../resources/canoe.jpg").toExternalForm()), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, bs);
        ...
        backgroundImage = new BackgroundImage(new Image(getClass().getResource("../resources/paintball.jpg").toExternalForm()), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, bs);
        paintball.setBackground(new Background(backgroundImage));

        backgroundImage = new BackgroundImage(new Image(getClass().getResource("../resources/o6eenzusfmv1cy4ytg6t.jpg").toExternalForm()), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, bs);
